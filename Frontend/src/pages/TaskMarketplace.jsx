    ...
    <Layout>
      <div className="bg-white min-h-screen">
        <div className="container mx-auto px-6 py-12">
          {/* Header */}
          <div className="bg-gray-900 text-white rounded-xl p-10 mb-10 text-center shadow-lg">
            ...
            <Link 
              to="/create-task"
              className="mt-6 inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-lg text-white bg-transparent hover:bg-white hover:text-gray-900 transition-colors"
            >
              + Create Task
            </Link>
          </div>
          {/* Search Bar Only */}
            ...
            <div className="relative w-full max-w-md border border-black rounded-md p-2 mr-10">
              <input
                type="text"
